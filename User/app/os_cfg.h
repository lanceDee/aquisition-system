...
#define OS_CFG_H
                                             ...
                                             /* ---------------------------- MISCELLANEOUS -------------------------- */
#define OS_CFG_APP_HOOKS_EN             1u   /* Enable (1) or Disable (0) application specific hooks    lancedemo         */
#define OS_CFG_ARG_CHK_EN               1u   /* Enable (1) or Disable (0) argument checking             lancedemo         */
#define OS_CFG_CALLED_FROM_ISR_CHK_EN   1u   /* Enable (1) or Disable (0) check for called from ISR     lancedemo               */
#define OS_CFG_DBG_EN                   1u   /* Enable (1) debug code/variables                         lancedemo     */
#define OS_CFG_ISR_POST_DEFERRED_EN     1u   /* Enable (1) or Disable (0) Deferred ISR posts            lancedemo              */
#define OS_CFG_OBJ_TYPE_CHK_EN          1u   /* Enable (1) or Disable (0) object type checking 					lancedemo                       */
